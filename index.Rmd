...
if (is_html_output()) {
  ...
  # Copy over v1 and v2 outline files
  from_vec <- here::here("outlines")
  to_vec <- here::here("docs", "outlines")
  fs::dir_copy(from_vec, to_vec, overwrite = TRUE)
